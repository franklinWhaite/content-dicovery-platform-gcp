...
public class ServiceTypes {
  ...
  public record ContentAndMetadata(String content, String link, Double distance) {
    public ServiceTypes.LinkAndDistance toLinkAndDistance() {
  ...
  public record UserQuery(String text, String sessionId, ServiceTypes.QueryParameters parameters) {}

  public record QueryResult(
      String content,
      String previousConversationSummary,
      List<ServiceTypes.LinkAndDistance> sourceLinks) {}
  ...
  public record ContentInfo(List<ServiceTypes.Info> content) {}
